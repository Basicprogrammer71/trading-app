...
# Navigation
page = st.radio("", ["Dashboard", "All Trades", "Historical Overview"], horizontal=True)
...
if page == "Dashboard":
    ...
    if not trades_df.empty:
        ...
        if st.button("Clear All Trades"):
            ...
            client.open("Trade Tracker Data").sheet1.append_row(
                ["Date","Position","Type","P/L","Notes","Account Value"]
            )
